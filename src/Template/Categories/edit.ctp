			...
			<div class="page-title-box">
				<div class="float-right">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="<?php echo $this->Url->build(['controller' => 'Categories', 'action' => 'view', '?' => ['id' => $category->id]]); ?>">カテゴリ詳細</a></li>
						<li class="breadcrumb-item active">カテゴリ編集</li>
					</ol>
				</div>
				<h4 class="page-title"><?= __('カテゴリ編集') ?></h4>
			...
			<div class="card">
				<div class="card-body">
					...
					<fieldset>
						...
						<p class="text-muted mb-3"><?= __('修正するカテゴリの情報を入力してください。') ?></p>
					...
					<div class="row mt-4">
						<div class="col-12 text-center">
							...
							<a href="<?= $this->Url->build(['controller' => 'Categories',
									'action' => 'view', '?' => ['id' => $category->id]]); ?>" class="btn btn-info mr-3">
