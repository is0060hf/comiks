			...
			<div class="page-title-box">
				<div class="float-right">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="<?php echo $this->Url->build(['controller' => 'PageNames', 'action' => 'view', '?' => ['id' => $pageName->id]]); ?>">固定ページ詳細</a></li>
						<li class="breadcrumb-item active">固定ページ編集</li>
					</ol>
				</div>
				<h4 class="page-title"><?= __('固定ページ編集') ?></h4>
			...
			<div class="card">
				<div class="card-body">
					...
					<fieldset>
						...
						<?php
						echo $this->Form->hidden('mode', array('user_id' => $this->request->getData('user_id')));
					...
					<div class="row mt-4">
						<div class="col-12 text-center">
							...
							<a href="<?= $this->Url->build(['controller' => 'PageNames',
								'action' => 'view', '?' => ['id' => $pageName->id]]); ?>" class="btn btn-info mr-3">
