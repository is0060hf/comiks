				...
				<div class="tab-content">
					<div class="tab-pane active " id="ActivityTab" role="tabpanel">
						<div class="bg-light mx-n3">
							<img src="/metrica_assets/images/small/img-1.gif" alt="" class="d-block mx-auto my-4" height="180">
						</div>
						...
						<div class="slimscroll scroll-rightbar">
							<div class="p-2">
								<div class="media mb-3">
									<img src="/metrica_assets/images/widgets/project3.jpg" alt="" class="thumb-lg rounded-circle">
