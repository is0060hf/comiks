 ...
 * @var \App\Model\Entity\PostImage[]|\Cake\Collection\CollectionInterface $postImages
 */
?>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $postImage->id], ['confirm' => __('Are you sure you want to delete # {0}?', $postImage->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
