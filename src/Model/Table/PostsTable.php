...
class PostsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('title_sub1')
            ->maxLength('title_sub1', 256)
            ->allowEmptyString('title_sub1');

        $validator
            ->scalar('title_sub2')
            ->maxLength('title_sub2', 256)
            ->allowEmptyString('title_sub2');
        ...
        $validator
            ...
            ->maxLength('featured_image', 512)
            ->allowEmptyFile('featured_image');

        $validator
            ->date('open_date')
            ->requirePresence('open_date', 'create')
            ->notEmptyDate('open_date');

        $validator
            ->scalar('is_open')
            ->maxLength('is_open', 32)
            ->allowEmptyString('is_open');
